...
class Tracker:
    ...
    def get_object_tracker(self, frames, read_from_stub = False, stub_path = None):
        ...
        tracks={
            ...
            "referees":[], # {frame_num: {track_id: {"bbox": [x1, y1, x2, y2]}}}
            "ball":[]   # {frame_num: {1: {"bbox": [x1, y1, x2, y2]}}}
        }
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        #Draw a Little transparent rectangle
        overlay = frame.copy()
        ...
        #Get no of frames each team had ball control
